...
export function buildUiRefs(documentRef = document) {
  return {
    ...
    scenarioListChipIcons: documentRef.getElementById('editor-list-chip-icons'),
    scenarioListChipPrimaryIconInput: documentRef.getElementById('scenario-list-chip-primary-icon-input'),
    scenarioListChipPrimaryIconUpload: documentRef.getElementById('scenario-list-chip-primary-icon-upload'),
    scenarioListChipPrimaryIconReset: documentRef.getElementById('scenario-list-chip-primary-icon-reset'),
    scenarioListChipPrimaryIconMode: documentRef.getElementById('scenario-list-chip-primary-icon-mode'),
    scenarioListChipSecondaryIconInput: documentRef.getElementById('scenario-list-chip-secondary-icon-input'),
    scenarioListChipSecondaryIconUpload: documentRef.getElementById('scenario-list-chip-secondary-icon-upload'),
    scenarioListChipSecondaryIconReset: documentRef.getElementById('scenario-list-chip-secondary-icon-reset'),
    scenarioListChipSecondaryIconMode: documentRef.getElementById('scenario-list-chip-secondary-icon-mode'),
    scenarioListChipDetailIconInput: documentRef.getElementById('scenario-list-chip-detail-icon-input'),
    scenarioListChipDetailIconUpload: documentRef.getElementById('scenario-list-chip-detail-icon-upload'),
    scenarioListChipDetailIconReset: documentRef.getElementById('scenario-list-chip-detail-icon-reset'),
    scenarioListChipDetailIconMode: documentRef.getElementById('scenario-list-chip-detail-icon-mode'),
