...
export function buildUiRefs(documentRef = document) {
  return {
    ...
    bgImagePresetRow: documentRef.getElementById('bg-image-preset-row'),
    bgImageUpload: documentRef.getElementById('bg-image-upload'),
    bgImageUploadRow: documentRef.getElementById('bg-image-upload-row'),
    bgImageReset: documentRef.getElementById('bg-image-reset'),
    bgImageAlpha: documentRef.getElementById('bg-image-alpha'),
    bgImageAlphaRow: documentRef.getElementById('bg-image-alpha-row'),
