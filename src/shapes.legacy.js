...
(function(){
  window.SHAPES = {
    ...
    circle:{main:{w:80,h:80,br:'40px',tx:-40,ty:-40,op:1},left:{w:80,h:80,br:'40px',tx:-40,ty:-40,op:0},right:{w:80,h:80,br:'40px',tx:-40,ty:-40,op:0}},
    listening:{main:{w:80,h:80,br:'40px',tx:-40,ty:-40,op:1},left:{w:80,h:80,br:'40px',tx:-40,ty:-40,op:0},right:{w:80,h:80,br:'40px',tx:-40,ty:-40,op:0}},
